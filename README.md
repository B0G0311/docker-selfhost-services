...
* [airsonic-advanced](airsonic-advanced/) - music collection server and player
* [dashy](dashy/) - home server dashboard
* [prowlarr](download-stack/) - indexer management
* [qbittorrent](download-stack/) - torrent client
* [freshrss](freshrss/) - RSS feed aggregator
* [gotify](gotify/) - notification service
* [heimdall](heimdall/) - simple landing page with custom bookmarks
* [jellyfin](jelly-stack/) - media system
* [jellyseerr](jelly-stack/) - media request manager
* [nextcloud](nextcloud/) - file-hosting software system
* [radarr](organizarr-stack/) - movie metadata manager
* [readarr](organizarr-stack/) - ebook metadata manager
* [sonarr](organizarr-stack/) - show metadata manager
...
Traefik is the core of this setup as it is the reverse proxy, it should be one of the first services to configure and use. This guide is set to be used with Cloudflare, however, it can be configured with a wide range of DNS managers with a little bit of configuration.
...
```bash
git clone https://github.com/B0G0311/docker-selfhost-services.git
```
...
UFW is a popular iptables front end on Ubuntu and other major Linux distributions that makes it easy to manage firewall rules. But when Docker is installed, Docker bypass the UFW rules and the published ports can be accessed from outside.
...
This guide is inspired from [@BaptisteBdn](https://github.com/BaptisteBdn/docker-selfhosted-apps) own docker guide, built with traefik at its core using OVH. It is definitely worth checking out, there are a few different services and slight config changes that might help in different usecases.
